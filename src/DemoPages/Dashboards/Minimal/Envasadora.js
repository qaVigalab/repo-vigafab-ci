            ...
            <CardBody>
              <Container>
                <Row>
                  ...
                  <Col>
                    {" "}
                    <div align="right" className="buttonenvase">
                      {" "}
            ...
            <Row>
              ...
              <Col>
                <div className="navegator">
                  <div align="center">7:00 - 14:30 | TURNO 1 | 08 Ene 2020</div>
                </div>
              </Col>
              <Col>
                <div className="flechas">
              ...
              <Col>
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <td>7:00 - 8:00</td>
                    <td width="20px">
                      <Produccion data={[2.2, 3, 2, 0.8, 0.3, 0.2, 5]} />
                    </td>
                    <td>
                      <Actividad
                        OE="12"
                    ...
                    <td>
                      <div className="circulo produccion" /> Producc
                      <div className="circulo rojo" /> Paro
                      <div className="circulo amarillo" /> Paro
                      <div className="circulo azul" /> Paro
                    </td>
                    <td>Tiempo</td>
                    <td>Razon</td>
                    <td>Comentario</td>
